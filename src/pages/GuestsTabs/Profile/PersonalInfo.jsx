...
const InfoList = [{lable: "Full Name:", value: "Rahul Sharma"},
  {lable: "Date of Birth:", value: "1992-05-05"},
  {lable: "Gender:", value: "Rahul Sharma"},
  {lable: "Location:", value: "Rahul Sharma"},
  {lable: "Registration:", value: "Rahul Sharma"}
]
      ...
      <div>
        ...
        <div>
          <div className="mx-auto w-32 h-32 rounded-full bg-linear-to-br from-teal-200 to-teal-100 flex items-center justify-center shadow-lg">
              <span className="text-teal-900 text-5xl font-bold">R</span>
          </div>
          {
            InfoList.map((info) => (
              <div key={info.lable} className="flex justify-between mt-4">
                ...
                <p className="font-poppins font-medium text-[14px] leading-5 tracking-[0px] text-[#101828]">{info.value}</p>
              </div>
            ))
          }
        </div>
